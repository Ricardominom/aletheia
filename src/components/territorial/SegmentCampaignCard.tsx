      ...
      <div className="glassmorphic-container p-6 min-h-[400px]">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-xl font-semibold text-white">Campaña por Segmento</h3>
                ...
                <div className="flex items-center gap-2">
                  <div className="flex-1 h-1 bg-background/50 rounded-full">
                    <div 
                      ...
                      style={{ width: `${Math.min((region.segmentsCount / Math.max(...regionsData.map(r => r.segmentsCount))) * 100, 100)}%` }}
                    />
                  </div>
