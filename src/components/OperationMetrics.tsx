          ...
          <tbody className="divide-y divide-accent-teal/10">
            {metrics.map((metric, index) => (
              ...
              >
                ...
                <td className="p-3 text-gray-300 text-sm font-medium">{`${metric.content.current}/${metric.content.target}`}</td>
                <td className="p-3 text-gray-300 text-sm font-medium whitespace-nowrap">{`${formatNumber(metric.impressions.current)}/${formatNumber(metric.impressions.target)}`}</td>
